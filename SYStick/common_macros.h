...
#define ASSIGN_PLLM_BITS_RCCPLL_CONFIC(REG,VALUE)                  (REG = ( (REG & 0XFFFFFFF0 ) | (VALUE) ) )
#define ASSIGN_PLLN_BITS_RCCPLL_CONFIC(REG,VALUE)                  (REG = ( (REG & 0XFFFF803F ) | (VALUE<<5) ) )
#define ASSIGN_PLLQ_BITS_RCCPLL_CONFIC(REG,VALUE)                  (REG = ( (REG & 0XF0FFFFFF ) | (VALUE<<23) ) )
